...
from gru.models import TCNRegressor
model_type = 'tcn'
'''
Helpers
'''
from utils import _info
from gru.rb_utils import dnn_score
...
if __name__ == '__main__':
    ...
    parser.add_argument('-k', '--k_fold', type=int,
        default=5, help='number of folds for cross validation, default=5')
    parser.add_argument('--k_hidden', type=int,
        default=25, help='size of hidden state, default=25')
    parser.add_argument('--k_wind', type=int,
        default=5, help='length of temporal window, default=5')
