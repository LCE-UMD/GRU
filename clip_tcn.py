...
from gru.models import TCNClassifier
...
def run(args):   
    ...
    param_grid = {'k_hidden':args.k_hidden,'k_wind':args.k_wind}
    ...
    if len(param_grid) == 1:
        res_path = (RES_DIR + 
                    ...
                    '_k_wind_%d_batch_size_%d' %(args.k_wind[0], args.batch_size) +
                    '_num_epochs_%d_z_%d.pkll' %(args.num_epochs, args.zscore))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-sn','--subnet', type=str,
                        default='wb',help='subnetwork (default: "wb")')
    ...
    parser.add_argument('--k_hidden',nargs='+', type=int,
        default=[25], help='size of hidden state (default: 32)')
    parser.add_argument('--k_wind', nargs='+', type=int,
        default=[5], help='number of gru layers default: 1')
